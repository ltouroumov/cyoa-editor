...
* **page** - top-level containers of the project, they allow multiple screens to be displayed.<br/>note: currently, only
...
* More built-in options (components) for "this choice contains other choices" (ie: allow picking sub-choices from a list
  or set of rows, with their own choice limit and/or sandboxed scores; this would make powers *Dynamist* easier to
  manage for users).
